...
<div class="container">
    <div class="row">
        <div class="col-8 mx-auto my-5 mt-5 chisiamo">
            <h1 class="text-center" style="font-family: 'great vibes'; font-size: 65px;">Chi siamo</h1>

        </div>
    </div>
    <div class="row">
        <div class="col-8 mx-auto">
          <h2 class="text-center">Debora</h2>
        </div>
    </div>
    <div class="row my-5">
        <div class=".col-12 col-md-6">
             <div class="contenitoreImg mx-auto mb-5">
    ...
    <div class="row my-5">
        ...
        <div class=".col-12 col-md-6">
            <div class="contenitoreImg mx-auto">
                <img src="https://i.ibb.co/pzyGKC2/estetista-1728x800-c.jpg" alt="foto2">
            </div>    
        </div>
   </div>
</div>
